    ...
    <div class="col-lg-12 container-fluid">
      ...
      <form class="row g-3 myForm" method="POST" action="/manga" enctype="multipart/form-data">
        ...
        <div class="col-lg-6">
          ...
          <div class="form-text">Format: JPG, PNG, WEBP. Maksimal 1MB.</div>
          <small class="text-muted d-block mt-1 file-info">Belum ada file dipilih.</small>
          @error('image') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>

        <div class="col-lg-12">
          <img class="img-preview img-fluid rounded border p-1 mt-1" style="max-height: 320px; display:none;" data-initial-src="">
        </div>
