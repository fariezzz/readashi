    ...
    <div class="col-lg-12 container-fluid">
      ...
      <form class="row g-3 myForm" method="POST" action="/borrowing">
        ...
        <div class="col-lg-4">
          ...
          <input type="date" class="form-control @error('borrow_date') is-invalid @enderror" name="borrow_date" id="borrow_date" value="{{ old('borrow_date', now()->toDateString()) }}">
        ...
        <div class="col-lg-6">
          ...
          <input type="number" min="0" class="form-control @error('fine') is-invalid @enderror" name="fine" id="fine" value="{{ old('fine', 0) }}">
