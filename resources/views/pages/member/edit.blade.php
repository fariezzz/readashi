...
<div class="mx-3 container-fluid">
    ...
    <div class="col-lg-12 container-fluid">
      ...
      <form class="row g-3" method="POST" action="/member/{{ $member->id }}">
        @method('put')
        @csrf
        <div class="col-lg-6">
          <label for="name" class="form-label">Name</label>
          <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $member->name) }}" required autofocus>
        ...
        <div class="col-lg-6">
          ...
          <input type="tel" class="form-control @error('contact') is-invalid @enderror" id="contact" name="contact" value="{{ old('contact', $member->contact) }}" required>
