...
<div class="mx-3 container-fluid">
    ...
    <div class="col-lg-12 container-fluid">
      ...
      <form method="POST" action="/genre/{{ $genre->slug }}">
        @method('put')
        @csrf
        <div class="row mb-3">
            <div class="col-lg-6">
        ...
        <div class="row mb-3">
            <div class="col-lg-6">
                ...
                <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{ old('slug', $genre->slug) }}" required>
